...
CONFIG_PATH="${CONFIG_PATH:-configs/railsem19/segformer_b0_rs19_512x512_100000it_earlystop.py}"
...
if [[ ! -d "$PROJECT_ROOT" ]]; then
	...
	echo "[TIP] set PROJECT_ROOT explicitly, e.g. PROJECT_ROOT=$PWD ./scripts/server_train_100k_earlystop.sh"
	exit 1
fi
